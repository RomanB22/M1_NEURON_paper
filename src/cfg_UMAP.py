...
cfg.region = 'm1'
cfg.n_components = 2
cfg.period = 'full_trial' # 'scaled_tone', 'scaled_prep', 'full_trial'
...
cfg.numCellsLong = 1 if cfg.singleCellPops else int(1000 * cfg.scaleDensity) # num of cells per population
