...
module load slurm            # <— this is the key bit (name may be slurm/<ver>)
module load cpu/0.17.3b  gcc/10.2.0/npcyll4  openmpi/4.1.3/oq3qvsv
module load neuron/8.0.0/njfqyq5
export LD_LIBRARY_PATH=/usr/lib64/slurm:$LD_LIBRARY_PATH
"""
